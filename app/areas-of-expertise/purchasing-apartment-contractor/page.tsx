...
export default function PurchasingApartmentContractorPage() {
  ...
  const content = {
    he: {
      ...
      breadcrumb: {
        home: "בית",
        land: "קרקע ונדל״ן",
        current: "רכישת דירה מקבלן",
      },
      hero: {
        title: "רכישת דירה מקבלן",
        subtitle: "לפני חתימה על חוזה עם קבלן, חשוב להבין מה אתה באמת חותם עליו. ליווי משפטי נכון יכול לחסוך לך כסף, עיכובים, והכי חשוב - כאבי ראש",
        scrollText: "גלול למטה",
      },
      whatIsSection: {
        title: "מה כל כך מסובך ברכישה מקבלן - ולמה לא כדאי לעשות את זה לבד?",
        leftColumn: [
          "מקבלן",
          "דירה",
          "קירות",
      ...
      info: {
        title: "חוזה עם קבלן זה לא חוזה רגיל",
        description: "מכירה מקבלן היא עסקה מורכבת הדורשת ליווי משפטי מקצועי. החוזה כולל סעיפים רבים הקשורים לתאריכי מסירה, פיצויים, תנאי ביטול ועוד. עורך דין מקצועי יוודא שהחוזה הוגן ושכל הסעיפים ברורים ומובנים.",
      },
      finalCta: {
    ...
    en: {
      ...
      breadcrumb: {
        home: "Home",
        land: "Land and real estate",
        current: "Purchasing an apartment from a contractor",
      },
      hero: {
        title: "Purchasing an apartment from a contractor",
        subtitle: "Before signing a contract with a contractor, it is important to understand what you are really signing. Proper legal guidance can save you money, delays, and most importantly, headaches.",
        scrollText: "SCROLL DOWN",
      },
      whatIsSection: {
        title: "What's so complicated about buying from a contractor - and why shouldn't you do it yourself?",
        leftColumn: [
          "From a contractor",
          "apartment",
          "Walls",
      ...
      cta: {
        title: "There is someone who will take care of you",
      ...
      info: {
        title: "A contract with a contractor is not a normal contract",
        description: "A contractor sale is a complex transaction that requires professional legal guidance. The contract includes many clauses related to delivery dates, compensation, cancellation terms, and more. A professional lawyer will ensure the contract is fair and all clauses are clear and understandable.",
      },
      finalCta: {

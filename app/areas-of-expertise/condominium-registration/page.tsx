...
export default function CondominiumRegistrationPage() {
  ...
  const content = {
    he: {
      ...
      hero: {
        title: "רישום דירות",
        subtitle: "לא רשום את הבית שלך כדירה? הגיע הזמן להסדיר את זכויות הקניין שלך",
        description: "רישום נכון שווה שקט משפטי, סדר - ושמירה על ערך הנכס",
        scrollText: "גלול למטה",
      },
      whatIsSection: {
        title: "מה זה דירה בכלל - ולמה חשוב לרשום אותה?",
        leftColumn: [
          "כבית",
          "רשום",
          "הדירות",
        ...
        rightColumn: "דירה היא בניין עם מספר דירות, כאשר כל דירה רשומה כיחידה נפרדת ברשם המקרקעין. ללא רישום, כל הנכס נחשב רכוש משותף, מה שמקשה על מכירה, העברת זכויות, קבלת משכנתאות, והגדרה ברורה של חניות או מחסנים. רישום נכון מגדיר זכויות קניין ברורות, שומר על סדר בבניין ומבטיח ערך גבוה יותר לכל דירה.",
      },
      cta: {
        title: "רוצים להבטיח זכויות ברורות בכל דירה ובשטחים המשותפים?",
        subtitle: "השאירו פרטים ונחזור אליכם עם ליווי משפטי מלא לרישום הבית כדירה ברשם המקרקעין",
        name: "שם*",
        phone: "טלפון*",
        email: "אימייל",
        send: "שליחה",
      ...
      info: {
        title: "מה זה דירה ולמה חשוב לרשום אותה?",
        description: "דירה היא בניין עם מספר דירות, כאשר כל דירה רשומה כיחידה נפרדת ברשם המקרקעין. ללא רישום, כל הנכס נחשב רכוש משותף, מה שמקשה על מכירה, העברת זכויות, קבלת משכנתאות, והגדרה ברורה של חניות או מחסנים. רישום נכון מגדיר זכויות קניין ברורות, שומר על סדר בבניין - ומבטיח ערך גבוה יותר לכל דירה.",
      },
      finalCta: {
    ...
    en: {
      ...
      breadcrumb: {
        home: "Home",
        land: "Land and real estate",
        current: "Condominium registration",
      },
      hero: {
        title: "Condominium registration",
        subtitle: "Haven't you registered your home as a condominium? It's time to regulate your property rights",
        description: "Proper registration equals legal peace, order - and maintaining the value of the property",
        scrollText: "scroll down",
      },
      whatIsSection: {
        title: "What is a condominium anyway - and why is it important to register it?",
        leftColumn: [
          "As a house",
          "registered",
          "The apartments",
        ...
        rightColumn: "A condominium is a building with multiple apartments, where each apartment is registered as a separate unit in the land registry. Without registration, the entire property is considered joint property, making it difficult to sell, transfer rights, obtain mortgages, and clearly divide parking spaces or storage areas. Proper registration defines clear property rights, maintains order in the building and ensures higher value for each apartment.",
      },
      cta: {
        title: "Want to ensure clear rights in each apartment and common areas?",
        subtitle: "Leave details and we will get back to you with full legal support for registering the house as a condominium in the Land Registry",
        name: "name*",
        phone: "phone*",
        email: "Email",
        send: "sending",
      ...
      info: {
        title: "What is a condominium and why is it important to register it?",
        description: "A condominium is a building with multiple apartments, where each apartment is registered as a separate unit in the land registry. Without registration, the entire property is considered joint property, making it difficult to sell, transfer rights, obtain mortgages, and clearly divide parking spaces or storage areas. Proper registration defines clear property rights, maintains order in the building - and ensures a higher value for each apartment.",
      },
      finalCta: {
  ...
  return (
    ...
    >
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        {/* Video Background */}
        <VideoBackground
          videoSrc="/videos/bg-video1.mp4"
          fallbackImage="/images/hero-bg.png"
          alt="Building view background"
          className="z-0"
        />
      ...
      {/* Condominium Explanation Section */}
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              className="flex flex-col justify-center h-96"
            >
      ...
      {/* Condominium Registration Contact Form */}
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
            {/* Left Image - Architectural Models */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            >
              <Image
                src="/images/freepik__two-wooden-house-models-one-smaller-and-one-larger__98483.jpg"
                alt="Architectural model and hands"
                width={600}
                height={400}
            ...
            >
              ...
              {/* Text Overlay */}
              <div className="absolute top-4 right-4 bg-white/95 backdrop-blur-sm p-6 rounded-lg shadow-lg max-w-xs">
      ...
      {/* Condominium Definition Section */}
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
